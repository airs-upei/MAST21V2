...
deploy_MAST21V2_2024 <- function(
  ...
  #   languages = language,
  #   musicassessr_state = musicassessr_state,
  #   setup_options = musicassessr::setup_pages_options(input = if(data_collection_method == "midi") "midi_keyboard" else if(data_collection_method == "audio") "microphone" else "key_presses",
  #                                                     headphones = TRUE,
